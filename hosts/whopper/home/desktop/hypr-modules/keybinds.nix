...
in {
  ...
  bind = [
    ...
    "CTRL SHIFT, 2, exec, grab_screen_text"
    "CTRL SHIFT, 3, exec, create_screenshot"
    "CTRL SHIFT, 4, exec, create_screenshot_area"
    "CTRL SHIFT, 5, exec, record_screen"
