  ...
  services.hypridle = {
    ...
    settings = {
      general = {
        ...
        before_sleep_cmd = "systemctl stop docker-ollama.service && loginctl lock-session";
        after_sleep_cmd = "${hyprctlBin} dispatch dpms on && systemctl start docker-ollama.service";
