{
  ...
  */
  ...
  #   "idle_inhibit always,class:^steam_app_.*$"
  #   "idle_inhibit fullscreen,class:^duckstation-qt.*$"
  #   "idle_inhibit fullscreen,class:^chromium-browser.*$"
  #   "idle_inhibit fullscreen,class:^zen.*$"
  #   "idle_inhibit always,class:^Ryujinx.*$"
  ...
  #   "dim_around,class:polkit-gnome-authentication-agent-1"
  ...
  windowrule = [
    ...
    "match:class polkit-gnome-authentication-agent-1, dim_around"
    ...
    "match:class (xdg-desktop-portal-gtk), dim_around"
